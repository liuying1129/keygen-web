...
function enCryptStr(){
	...
	$.ajax({
		...
		error : function(xhr, textStatus, errorThrown) {
			...
			console.log("ajax请求失败,请求:enCrypt,状态码:"+xhr.status +",状态说明:"+ textStatus+",xhr readyState:"+xhr.readyState);
		}
	});
}
...
function deCryptStr(){
	...
	$.ajax({
		...
		error : function(xhr, textStatus, errorThrown) {
			...
			console.log("ajax请求失败,请求:deCrypt,状态码:"+xhr.status +",状态说明:"+ textStatus+",xhr readyState:"+xhr.readyState);
		}
	});
}